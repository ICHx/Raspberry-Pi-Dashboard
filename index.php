...
$passVal = ($config->get("general.pass") !== '827ccb0eea8a706c4c34a16891f84e7b') ? '***' : '';
?>
<!doctype html>
<html lang="en">
...
<body onload="preload()" style="background-color: #eee">
  <noscript style="z-index: 99999!important; position: absolute; top: 0; width: 98%; padding: 3%;">
    <div class="alert alert-danger" role="alert">JavaScript is disabled in your browser. This site <b>requires</b> JS in order to work properly - please activate!</div>
  </noscript>
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark shadow-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <p style="color: white;line-height:15px;margin-bottom:0px"><b>Hostname:</b> <?php system("hostname"); ?> &#183; <b>Internal IP:</b> <?php echo $_SERVER["SERVER_ADDR"]; ?><br>
        <b>Access from:</b> <?php echo $_SERVER["REMOTE_ADDR"]; ?> &#183; <b>Port:</b> <?php echo $_SERVER['SERVER_PORT']; ?>
      </p>
    </div>
  </nav>

  <div style="margin-top:70px" class="container">
    <div class="row<?php if (!$auth) {
                      echo " hidden";
                    } ?>">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <p><i class="bi bi-clock-history"></i>
              <!--<img src="img/time-icon.png">-->&nbsp;Uptime: <b><span id="uptime"></span></b><?php if ($auth) { ?>&nbsp;(started <?= $uptstr; ?>)<?php } ?>
            </p>
            <table style="width:100%">
              <tbody>
                <tr>
                  <td style="width:10%"><button type="button" id="pctl" onclick="y=100; this.innerHTML=togglep(true);" class="btn btn-secondary btn-sm"><i class="bi bi-pause"></i></button></td>
                  <td style="width:90%">
                    <div class="progress" style="margin-top: 1px; height: 2px;">
                      <div class="progress-bar py" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </td>
                </tr>
              </tbody>
    ...
    <div class="row pt-3<?php if (!$auth) {
                          echo " hidden";
                        } ?>">
    ...
    <hr id="ldiv" class="my-4<?php if (!$auth) {
                                echo " hidden";
                              } ?>"><!-- Static infos, that won't be updated -->
    <?php
    if ($auth) {
    ?>
      <div class="row pt-3">
        ...
        <div class="col-sm-6 pt-1 pt-md-0">
          <div class="card text-center border-info">
            ...
            <div class="card-body">
              ...
              <samp><?php $ot = shell_exec("vcgencmd version");
                    if (strpos($ot, "failed") !== false) {
                      echo "<div class='alert alert-danger' role='alert'>Execution of system command failed. Please run<br><kbd>sudo usermod -aG video www-data</kbd><br>in a terminal to solve this problem.</div>";
                    } else {
                      echo $ot;
                    } ?></samp>
              <p class="card-text"><small class="text-muted">Updated <span><?php echo date("H:i:s"); ?> (at page load)</span></small></p>
      ...
      <div class="row pt-3">
        ...
        <div class="col-sm-6 pt-1 pt-md-0">
          <div class="card text-center border-info">
            ...
            <div class="card-body">
              <?php print "<pre>";
              echo shell_exec("lsb_release -av");
              // echo shell_exec("cat /etc/os-release"); //!default
              print "</pre>"; ?>
              <p class="card-text"><small class="text-muted">Updated <span><?php echo date("H:i:s"); ?> (at page load)</span></small></p>
            </div>
          </div>
          ...
          <div id="accordion">
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                  <h3>
                    <font class='text-success'>&#10003;</font> Version 0.10
                  </h3>
                  <ul>
                    <li>allow password change via options</li>
                    <li>updated <i>customize</i> section</li>
                    <li>notably improved Readme</li>
                    <li><a href='https://github.com/femto-code/Rasberry-Pi-Dashboard/releases'>Stay updated here</a></li>
                    <li><i><a href="CHANGELOG.md">All changes</a></i></li>
                  </ul>
            ...
            <div class="card">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                <div class="card-body">
                  <p>Your local dashboard project instance is located under: <code><?= $fol; ?></code>. Look for a file called <kbd>local.config</kbd>. Within this config file you can customize a few things of RPi Dashboard (e.g. thresholds, password).</p>
                  <p>See the notes in <kbd>README.md</kbd> for instructions.</p>
                </div>
              </div>
            </div>
            <div class="card">
  ...
  <footer style="line-height: 40px; background-color: #f5f5f5; margin-top: 10px;">
    <div class="container text-center">
      RPi Dashboard v0.10 <font class="text-muted">(Mar 2021)</font> <span id="dot">&middot;</span>
      <font id="notf" class="text-success">See the <a href="https://github.com/femto-code/Rasberry-Pi-Dashboard/releases">Github releases</a> for updates!</font><br />
